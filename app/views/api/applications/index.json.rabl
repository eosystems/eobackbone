...
child @applications => :results do
  ...
  attributes :id, :targetable_type, :targetable_id, :processing_status, :application_user_name, :process_user_name, :target_type_name, :uid,
  ...
  node(:has_api_manager_role) { current_user.has_api_manager_role? }
  node(:has_recruit_role) { current_user.has_recruit_role? }
end
